 ...
 * 圆角小窗里 4、3、2、1 依次荡过去，一秒一个；底下并排两颗图标，随时可以退出
 * 去或者按住不打。没有标题、没有说明文字：玩法是什么，那张图已经说完了。
 * 建议横着玩的那两个玩法从 5 数起，多出来的一秒是留给转手机的（见 countFrom）。
 *
 ...
 */
export function playCountdown(win: HTMLElement, done: () => void, from = 4): () => void {
