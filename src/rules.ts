...
export const RULES: Record<Lang, RuleBook> = {
  zhHans: {
    ...
    modes: [
      ...
      { term: '炸弹玩法', body: '红块不参与配对，是障碍。得分图案旁边的炸弹被打中两次就拆：第一次只留一道裂纹，第二次才变成一颗普通颜色的星星。3 个红块相互边相连时会闪烁描边预警；一旦 4 个及以上相连，立即结束并扣 100 分——这一步的连锁全部走完之后才判。' },
  ...
  zhHant: {
    ...
    modes: [
      ...
      { term: '炸彈玩法', body: '紅塊不參與配對，是障礙。得分圖案旁邊的炸彈被打中兩次就拆：第一次只留一道裂紋，第二次才變成一顆普通顏色的星星。3 個紅塊相互邊相連時會閃爍描邊預警；一旦 4 個及以上相連，立即結束並扣 100 分——這一步的連鎖全部走完之後才判。' },
