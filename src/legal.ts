  ...
  zhHans: {
    ...
    privacy: {
      ...
      items: [
        ...
        { term: '数据放在哪', body: '网站由 Vercel 托管。内部码开通的账号，以及多人游玩的小屋，存在我们的 Redis（Vercel KV／Upstash）里；银行卡订阅的记录在 Creem，商店订阅的记录在商店；其余设置都在你自己的设备上。这些服务都可能把数据存在欧盟以外，并依据标准合同条款进行跨境传输。' },
  ...
  zhHant: {
    ...
    privacy: {
      ...
      items: [
        ...
        { term: '資料放在哪', body: '網站由 Vercel 代管。內部碼開通的帳號，以及多人遊玩的小屋，存在我們的 Redis（Vercel KV／Upstash）裡；信用卡訂閱的紀錄在 Creem，商店訂閱的紀錄在商店；其餘設定都在你自己的裝置上。這些服務都可能把資料存在歐盟以外，並依標準契約條款進行跨境傳輸。' },
