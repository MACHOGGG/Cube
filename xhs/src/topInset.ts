 ...
 *
 * 实机量的：那三颗圆键上边 70pt、下边 100pt，容器报的安全区是 62pt。所以从
 * 安全区底下算起，它还占了 38pt。取 44（iOS/安卓导航栏的惯例高度），落点是
 * 106pt，比按钮下边多 6pt 的余地。
 */
const BAR = 44;
 ...
 *     安全区，**不含**它自己那排键。
 *
 * 所以这个容器报的就是设备安全区，按钮那一行要我们自己再让：62 + 44 = 106，
 * 落在按钮下边（100pt）再往下 6pt。
 *
