...
export const STRINGS: Record<Lang, I18nStrings> = {
  ...
  fr: {
    ...
    redeemBtn: 'Débloquer',
    passwordLabel: 'Code secret (6 caractères min.)',
    ...
    unlockNewPw: 'Nouveau code secret (6 caractères min.)',
  ...
  zhHant: {
    ...
    redeemCodeLabel: '內部碼',
    redeemBtn: '解鎖',
    passwordLabel: '密碼（6 位以上字元）',
    passwordPlaceholder: '6 位以上字元',
    passwordAny: '密碼',
    setPwTitle: '設定密碼',
  ...
  zhHans: {
    ...
    redeemCodeLabel: '内部码',
    redeemBtn: '解锁',
    passwordLabel: '密码（6 位以上字符）',
    passwordPlaceholder: '6 位以上字符',
    passwordAny: '密码',
    setPwTitle: '设置密码',
