...
export const STRINGS: Record<Lang, I18nStrings> = {
  en: {
    ...
    geniusSoonTitle: 'On the roadmap',
    ...
    setPwLabel: 'Password (exactly 6 letters or digits)',
  ...
  fr: {
    ...
    geniusSoonTitle: 'Sur la feuille de route',
    ...
    setPwLabel: 'Mot de passe (exactement 6 lettres ou chiffres)',
