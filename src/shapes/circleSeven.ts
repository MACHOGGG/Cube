...
// The board's two non-linear bonus shapes, identical relative offsets to the
// base circle board's own "22"/"121" (see circle.ts) — they transfer
// unchanged because they're expressed purely in local (r,c) steps, and this
// board's (r,c) space is a plain full rectangle (no triangular trimming to
// worry about), just with a different cellValid bound.
